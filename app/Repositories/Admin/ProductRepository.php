...
class ProductRepository implements ProductRepositoryInterface
{
    ...
    public function removeImage($id)
    {
        ...
        //dd($image->path);
        //storage/
        file::delete('storage/' . $image->path);
        File::delete('storage/' . $image->extra_large);
        File::delete('storage/' . $image->large);
        File::delete('storage/' . $image->medium);
        File::delete('storage/' . $image->small);
