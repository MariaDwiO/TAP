        ...
        <div class="card-body">
          ...
          <div class="card-title text-center"><h2>{{ $title }} Product</h2></div>
            ...
            <link rel="stylesheet" type="text/css" href="{!! URL::asset('template/assets/style.css') !!}">
                ...
                <div class="form-group">
                  {!! Form::label('prince', 'Prince Product') !!}
                ...
                <div class="form-group">
                  {!! Form::label('jurusan', 'Category Jurusan Product') !!}
                  {!! General::selectMultiLevel('jurusan', $categories, ['class' => 'form-control', 'selected' =>!empty(old('category_IDs'))? old ('category_IDs'):$categoryIDs,
